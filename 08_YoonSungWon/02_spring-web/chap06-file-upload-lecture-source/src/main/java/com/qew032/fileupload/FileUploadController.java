...
public class FileUploadController {
        ...
        * */
        ...
        public String singleFileUpload(
                ...
                System.out.println(singleFile.getSize());       // 파일 크기
        ...
        public String multiFileUploadDB(
                ...
                try{
                        ...
                        for(MultipartFile singleFile : multiFile) {
                                ...
                                if(files.size() >= 3) {
                                        // 저장된 파일이 3개가 되면 임의로 예외 발생
                                        throw new IOException("임의로 예외 발생");
                                }
                        ...
                        for(FileDTO  f : files) {
                                File file = new File(f.getFileDescription() + "/" + f.getSavedName());
